...
class TestMinimal3D : public CxxTest::TestSuite
{
  ...
  void TestMinimalSimulation()
  {
    ...
    HeartConfig::Instance()->SetIntracellularConductivities(Create_c_vector(0.0005, 0.05, 0.075)); // these are quite smaller than cm values
    HeartConfig::Instance()->SetExtracellularConductivities(Create_c_vector(0.0005, 0.05, 0.075)); // these are quite smaller than cm values
