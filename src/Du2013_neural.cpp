...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[2] = 0.00097499999999999996; // (var_intracellular_Ca__beta) [millimolar_per_time_units]
        this->mParameters[3] = 1.2; // (var_i_BK__G_max_BK) [conductance_units]
    }
    ...
    double CellDu2013_neuralFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_i_BK__I_BK = (-var_i_BK__E_K + var_chaste_interface__Membrane__V_m) * var_d_BK__d_BK * mParameters[3]; // current_units
    ...
    void CellDu2013_neuralFromCellML::EvaluateYDerivatives(double var_chaste_interface__Time__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_intracellular_Ca__IP_3 = ((1.0 - pow(var_chaste_interface__Membrane__V_m, var_intracellular_Ca__r) / (pow(var_chaste_interface__Membrane__V_m, var_intracellular_Ca__r) + pow(var_intracellular_Ca__k_v, var_intracellular_Ca__r))) * var_intracellular_Ca__P_MV - var_chaste_interface__intracellular_Ca__IP_3 * var_intracellular_Ca__eta - pow(var_chaste_interface__intracellular_Ca__IP_3, var_intracellular_Ca__u) * var_intracellular_Ca__V_M4 / (pow(var_chaste_interface__intracellular_Ca__IP_3, var_intracellular_Ca__u) + pow(var_intracellular_Ca__k_4, var_intracellular_Ca__u)) + mParameters[2]) * mParameters[1]; // millimolar / time_units
