...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[2] = 0.038899999999999997; // (var_intracellular_Ca__eta) [per_time_units]
        this->mParameters[3] = 0; // (var_neural__stim_cholinergic) [dimensionless]
        this->mParameters[4] = 0; // (var_neural__stim_nitrergic) [dimensionless]
        this->mParameters[5] = 120000.0; // (var_neural__stim_end) [time_units]
        this->mParameters[6] = 60000.0; // (var_neural__stim_start) [time_units]
    }
    ...
    double CellDu2013_CalibNeurFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_neural__gbk_neur = var_neural__m * exp(var_neural__n * mParameters[4]); // conductance_units
    ...
    void CellDu2013_CalibNeurFromCellML::EvaluateYDerivatives(double var_chaste_interface__Time__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_neural__beta_neur = var_neural__i * exp(var_neural__j * mParameters[3]) + var_neural__k * exp(var_neural__l * mParameters[3]); // millimolar_per_time_units
        const double d_dt_chaste_interface_var_intracellular_Ca__IP_3 = ((1.0 - pow(var_chaste_interface__Membrane__V_m, var_intracellular_Ca__r) / (pow(var_chaste_interface__Membrane__V_m, var_intracellular_Ca__r) + pow(var_intracellular_Ca__k_v, var_intracellular_Ca__r))) * var_intracellular_Ca__P_MV - var_chaste_interface__intracellular_Ca__IP_3 * mParameters[2] - pow(var_chaste_interface__intracellular_Ca__IP_3, var_intracellular_Ca__u) * var_intracellular_Ca__V_M4 / (pow(var_chaste_interface__intracellular_Ca__IP_3, var_intracellular_Ca__u) + pow(var_intracellular_Ca__k_4, var_intracellular_Ca__u)) + var_neural__beta_neur) * mParameters[1]; // millimolar / time_units
